...
export const colorVariants: Record<string, ColorVariant> = {
  teal: {
    ...
    selected:
      "bg-gradient-to-r from-teal-500 to-teal-600 dark:from-teal-600 dark:to-teal-700 text-white shadow-lg",
  ...
  blue: {
    ...
    selected:
      "bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white shadow-lg ring-2 ring-blue-200 dark:ring-blue-800 ring-offset-2 dark:ring-offset-gray-900",
  ...
  green: {
    ...
    selected:
      "bg-gradient-to-r from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 text-white shadow-lg ring-2 ring-green-200 dark:ring-green-800 ring-offset-2 dark:ring-offset-gray-900",
  ...
  purple: {
    ...
    selected:
      "bg-gradient-to-r from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 text-white shadow-lg ring-2 ring-purple-200 dark:ring-purple-800 ring-offset-2 dark:ring-offset-gray-900",
