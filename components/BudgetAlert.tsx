...
const BudgetAlert = () => {
  ...
  return (
    <div className={`px-4 md:px-8 pb-4 ${isOverBudget ? "animate-pulse" : ""}`}>
      ...
      >
        <AlertTriangle
          className={`w-5 h-5 shrink-0 mt-0.5 ${isOverBudget ? "text-red-400" : "text-yellow-400"}`}
        />
        <div className="flex-1">
          <h3
            className={`text-sm font-semibold mb-1 ${isOverBudget ? "text-red-300" : "text-yellow-300"}`}
          >
